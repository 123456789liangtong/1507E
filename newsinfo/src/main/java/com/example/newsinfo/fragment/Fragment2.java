...
public class Fragment2 extends Fragment implements XListView.IXListViewListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getContent("http://v.juhe.cn/toutiao/index?type=guonei&key=54e3d5f4ee64f51bef570ce8505d37b5");
        //http://v.juhe.cn/toutiao/index?type=\%22%20+%20android.R.attr.name%20+%20\%22&key=54e3d5f4ee64f51bef570ce8505d37b5
    ...
    private void getContent(String path) {
        ...
        new AsyncTask<String, Void, String>() {
            ...
            protected void onPostExecute(String s) {
                ...
                //GuoneiBean bean = gson.fromJson(s, GuoneiBean.class);
                List<Bean.ResultBean.DataBean> list = bean.getResult().getData();
                //List<GuoneiBean.ResultBean.DataBean> list = bean.getResult().getData();
                if(adapter == null){
